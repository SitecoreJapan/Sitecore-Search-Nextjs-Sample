    ...
    <NavMenu.List className={styles['sitecore-nav-menu-sub-list']}>
      {!loading &&
        articles.map((article, index) => (
          <NavMenu.Item key={article.id} className={styles['sitecore-nav-menu-sub-item']}>
            <NavMenu.Link
              href={article.url}
              onClick={(e) => {
                e.preventDefault();
            ...
            >
              <ArticleCard.Root className={styles['sitecore-article-root']}>
                <div className={styles['sitecore-article-image-wrapper']}>
                  <ArticleCard.Image src={article.image_url} className={styles['sitecore-article-image']} />
                </div>
                <ArticleCard.Title className={styles['sitecore-article-name']}>{article.name}</ArticleCard.Title>
              </ArticleCard.Root>
            </NavMenu.Link>
          </NavMenu.Item>
        ))}
            ...
            {!loading && (
              ...
              >
                ...
                >
                  ...
                  >
                    <NavMenu.Trigger aria-hidden className={styles['sitecore-nav-menu-default-trigger']} />
